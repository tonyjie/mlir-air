...
Loads Qwen3-0.6B (Qwen3ForCausalLM) weights from HuggingFace safetensors
...
@dataclass
class LlamaConfig:
    """Qwen3-0.6B model hyperparameters.
...
@dataclass
class LlamaWeights:
    """All weights for a Qwen3-0.6B model."""
...
def load_weights(
    ...
    """Load Qwen3-0.6B weights from safetensors into numpy arrays."""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Load Qwen3-0.6B weights and print shapes"
    )
    parser.add_argument("model_path", type=str, nargs="?", default="Qwen/Qwen3-0.6B")
    parser.add_argument(
