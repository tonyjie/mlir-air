...
"""CPU reference forward pass for Qwen3-0.6B (Qwen3ForCausalLM).
...
def attention_reference(q, k, v, n_heads, n_kv_heads):
    ...
    For Qwen3-0.6B: 16 Q heads, 8 KV heads, group_size = 2.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="CPU reference forward pass for Qwen3-0.6B"
    )
