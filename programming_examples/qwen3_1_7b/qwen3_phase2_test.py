...
"""Phase 2 — single-block correctness for Qwen3-1.7B on NPU2.
...
def main():
    parser = argparse.ArgumentParser(
        description="Qwen3-1.7B Phase 2 single-block test (NPU)"
    )
    parser.add_argument(
        "--seq-len",
        type=int,
    ...
    config = LlamaConfig()
    print(
        f"Qwen3-1.7B config: n_layers={config.n_layers}, "
