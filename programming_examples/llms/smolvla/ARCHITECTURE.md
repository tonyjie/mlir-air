...
Companion to [README.md](README.md) (overview, quick start, results) and
[docs/code_walkthrough.md](docs/code_walkthrough.md) (a reading guide for
someone who has not seen this code). This doc covers how the per-layer kernel
chain and the runtime are organized.
